...
export const PROJECT_TEMPLATES: ProjectTemplate[] = [
  ...
  },
  {
    id: 'equipment-mgmt',
    name: '설비별 관리',
    description: '설비별 정기 점검, 소모품 교체 및 이력 관리 프로젝트.',
    category: 'Operations',
    icon: <SettingsIcon />,
    color: '#0891B2',
    subProjects: [
      { name: 'CMP 설비', description: 'Chemical Mechanical Polishing' },
      { name: 'Cleaning 설비', description: '세정 및 건조' },
    ],
    defaultTasks: [
      {
        title: 'CMP-01 정기 점검',
        status: 'todo', priority: 'high',
        start_date: relativeDate(0), due_date: relativeDate(1),
        subproject: 'CMP 설비',
        activities: [
          { content: '압력 센서 교정 상태 확인', block_type: 'checkbox', checked: false },
          { content: '슬러리 공급 라인 누출 점검', block_type: 'checkbox', checked: false },
        ],
      },
      {
        title: 'CMP-02 소모품 교체',
        status: 'in_progress', progress: 20,
        start_date: relativeDate(-1), due_date: relativeDate(2),
        subproject: 'CMP 설비',
        activities: [
          { content: 'Pad 교체 주기 확인', block_type: 'checkbox', checked: true },
          { content: 'Retainer Ring 상태 점검', block_type: 'checkbox', checked: false },
        ],
      },
      {
        title: 'CMP-03 알람 이력 확인',
        status: 'todo',
        start_date: relativeDate(0), due_date: relativeDate(0),
        subproject: 'CMP 설비',
      },
      {
        title: 'CMP-04 Recipe/Parameter 점검',
        status: 'todo',
        start_date: relativeDate(1), due_date: relativeDate(3),
        subproject: 'CMP 설비',
      },
      {
        title: 'CMP-05 작업 이력 정리',
        status: 'todo',
        start_date: relativeDate(3), due_date: relativeDate(4),
        subproject: 'CMP 설비',
      },
    ],
  },
