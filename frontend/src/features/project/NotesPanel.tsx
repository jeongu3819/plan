    ...
    return (
        <Box sx={{ maxWidth: 800 }}>
            ...
            {isLoading ? (
                ...
                <Paper sx={{ p: 6, textAlign: 'center', borderRadius: 2, border: '1px solid #E5E7EB' }} elevation={0}>
                    <StickyNote2Icon sx={{ fontSize: '3rem', color: '#D1D5DB', mb: 1 }} />
                    <Typography variant="body1" sx={{ color: '#6B7280', mb: 0.5 }}>메모가 없습니다</Typography>
                    <Typography variant="caption" sx={{ color: '#9CA3AF' }}>첫 번째 메모를 작성해보세요</Typography>
                </Paper>
            ) : (
                            ...
                            <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2 }}>
                                ...
                                <Box sx={{ flexGrow: 1, minWidth: 0 }}>
                                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 0.8 }}>
                                        <Typography variant="body2" sx={{ fontWeight: 600, fontSize: '0.85rem', color: '#1A1D29' }}>
