...
import {
    ...
    TextField, MenuItem, Tooltip, TableSortLabel,
} from '@mui/material';
                ...
                <Table>
                    <TableHead>
                        <TableRow sx={{ bgcolor: '#FAFBFC' }}>
                            ...
                            <TableCell sx={{ fontWeight: 700, color: '#374151', fontSize: '0.8rem', py: 1.5, width: 100 }}>
                                <TableSortLabel
                            ...
                            <TableCell sx={{ fontWeight: 700, color: '#374151', fontSize: '0.8rem', py: 1.5, width: 120 }}>
                                <TableSortLabel
                    ...
                    <TableBody>
                        ...
                        {/* Subproject groups */}
                        {hasSubProjects && groupedTasks.subGroups.map(({ subProject, tasks: spTasks }) => {
                                    ...
                                    >
                                        <TableCell colSpan={5}>
                                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                                                ...
                                                <Typography variant="body2" sx={{ fontWeight: 700, fontSize: '0.85rem', color: '#5B21B6' }}>
                                                    {subProject.name}
                                                </Typography>
                                                <Chip
