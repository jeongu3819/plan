        ...
        {days.map(day => {
          ...
          return (
            ...
            >
              ...
              {/* Task dots */}
              {dayTasks.length > 0 && (
                <Tooltip title={`${dayTasks.length}개 task`} arrow placement="top">
                  <Box
                    sx={{
                      display: 'flex',
                      gap: 0.3,
                ...
                {selectedDayTasks.map(t => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <Typography
                        variant="body2"
                        sx={{ fontWeight: 600, fontSize: '0.88rem', flexGrow: 1, color: '#1A1D29' }}
                      >
                        {t.title}
                      </Typography>
                      ...
                      <IconButton
                        size="small"
                        sx={{ color: '#C0C4CC', flexShrink: 0, '&:hover': { color: '#2955FF' } }}
                      >
